...
import authorsPageInitialPaths49b88Resource from '../../../resources/authors-page-initial-paths-49b88'
import authorsPageInitialPropsE2d2eResource from '../../../resources/authors-page-initial-props-e2d2e'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPaths49b88Resource({})
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialPropsE2d2eResource({
    ...context?.params,
